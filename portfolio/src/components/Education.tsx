  ...
  return (
    ...
    >
      <div className="section-container">
        ...
        <StaggerContainer staggerDelay={0.15} className="edu-grid">
          {education.map((edu, i) => (
            <StaggerItem key={i}>
              <div
                className="glass-card"
                style={{ padding: "36px", borderColor: "rgba(255,255,255,0.06)", position: "relative", overflow: "hidden" }}
              >
                {/* Background accent */}
                <div style={{
                ...
                <div style={{ marginBottom: 20 }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 8, marginBottom: 8 }}>
                    <h3 style={{ fontSize: 17, fontWeight: 700, color: "#ededed", fontFamily: "Poppins, sans-serif", lineHeight: 1.3 }}>
                      {edu.degree}
                    </h3>
                    {edu.current && (
                      <span style={{
                  ...
                  <p style={{ fontSize: 14, color: "#cccccc", fontWeight: 600, fontFamily: "Poppins, sans-serif", marginBottom: 4 }}>
                    {edu.short}
                  </p>
                  <p style={{ fontSize: 13, color: "#3a3a3a", fontFamily: "Poppins, sans-serif" }}>
                    {edu.institution}
                  </p>
                </div>
                ...
                <div style={{ display: "flex", gap: 20, marginBottom: 20, flexWrap: "wrap" }}>
                  <span style={{ display: "flex", alignItems: "center", gap: 6, fontSize: 13, color: "#3a3a3a", fontFamily: "Poppins, sans-serif" }}>
                    <span style={{ color: "#2a2a2a" }}><CalendarIcon /></span>
                    {edu.period}
                  </span>
                  <span style={{ display: "flex", alignItems: "center", gap: 6, fontSize: 13, color: "#3a3a3a", fontFamily: "Poppins, sans-serif" }}>
                    <span style={{ color: "#2a2a2a" }}><MapPinIcon /></span>
                    {edu.location}
                  </span>
                </div>
                ...
                <ul style={{ listStyle: "none", display: "flex", flexDirection: "column", gap: 8 }}>
                  {edu.highlights.map((h, j) => (
                    <li key={j} style={{
                      ...
                      <span style={{ position: "absolute", left: 0, color: "#555555", top: 4 }}>
                        <DiamondIcon />
                      </span>
                      {h}
                    </li>
